...
#
# MidtermV2_Conv_Only_Vivado.tcl: Tcl script for re-creating project 'MidtermV2_Conv_Only_Vivado'
#
# Generated by Vivado on Thu Mar 19 13:40:10 +0100 2026
...
#
# 1. This project restoration tcl script (MidtermV2_Conv_Only_Vivado.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/stavs/Documents/Lab_HW_SW/Midterm_V2/Task2_CNN_Vivado/MidtermV2_Conv_Only_Vivado.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../../Task2_CNN_Vivado/MidtermV2_Conv_Only_Vivado.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../../../../AppData/Roaming/export"]"]"\
 "[file normalize "$origin_dir/../../../../../../AppData/Roaming/export_task2"]"]"\
  ]
  foreach ipath $paths {
...
set script_file "MidtermV2_Conv_Only_Vivado.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../Task2_CNN_Vivado"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../export"] [file normalize "$origin_dir/../../../export_task2"]" $obj
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces Conv2D_HW_0/Data_m_axi_gmem1] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.945066",
   "Default View_TopLeft":"-30,-565",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 6 -x 1840 -y -150 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 6 -x 1840 -y -120 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 2 -x 590 -y 70 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 5 -x 1680 -y 0 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 4 -x 1330 -y -250 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 1 -x 220 -y -410 -defaultsOSRD
preplace inst system_ila_0 -pg 1 -lvl 3 -x 980 -y 330 -defaultsOSRD
preplace inst system_ila_1 -pg 1 -lvl 4 -x 1330 -y 320 -defaultsOSRD
preplace inst Conv2D_HW_0 -pg 1 -lvl 4 -x 1330 -y 100 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 5 0 -70 360 -40 800 90 1140 -10 1540
preplace netloc processing_system7_0_FCLK_RESET0_N 1 2 2 820 -270 N
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 0 5 10 -60 N -60 810 100 1110 0 1530
preplace netloc Conv2D_HW_0_m_axi_gmem0 1 0 5 -10 -50 N -50 830 50 1160 10 1500
preplace netloc axi_interconnect_0_M00_AXI 1 1 1 370 -410n
preplace netloc processing_system7_0_DDR 1 2 4 NJ 20 1100 -150 NJ -150 N
preplace netloc processing_system7_0_FIXED_IO 1 2 4 NJ 40 1120 -120 NJ -120 N
preplace netloc processing_system7_0_M_AXI_GP0 1 2 3 NJ 80 1130 -60 N
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 4 830 110 1150 20 1520J 120 1820
preplace netloc system_ila_0_TRIG_OUT 1 3 1 1120 310n
preplace netloc Conv2D_HW_0_m_axi_gmem1 1 0 5 10 -560 NJ -560 NJ -560 NJ -560 1510
levelinfo -pg 1 -30 220 590 980 1330 1680 1840
pagesize -pg 1 -db -bbox -sgen -30 -590 1950 410
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../Task2_CNN_Vivado/MidtermV2_Conv_Only_Vivado.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]
} else {
