...
#define AUTOTB_TVIN_gmem0 "../tv/cdatafile/c.Conv2D_HW.autotvin_gmem0.dat"
#define AUTOTB_TVOUT_gmem0 "../tv/cdatafile/c.Conv2D_HW.autotvout_gmem0.dat"
#define AUTOTB_TVIN_gmem1 "../tv/cdatafile/c.Conv2D_HW.autotvin_gmem1.dat"
#define AUTOTB_TVOUT_gmem1 "../tv/cdatafile/c.Conv2D_HW.autotvout_gmem1.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_gmem0 "../tv/rtldatafile/rtl.Conv2D_HW.autotvout_gmem0.dat"
#define AUTOTB_TVOUT_PC_gmem1 "../tv/rtldatafile/rtl.Conv2D_HW.autotvout_gmem1.dat"
...
void apatb_Conv2D_HW_hw(void* __xlx_apatb_param_input_r, void* __xlx_apatb_param_output_r, void* __xlx_apatb_param_coeffs, hls::sim::Byte<4> __xlx_apatb_param_numChannels, hls::sim::Byte<4> __xlx_apatb_param_numFilters, hls::sim::Byte<4> __xlx_apatb_param_inputWidth, hls::sim::Byte<4> __xlx_apatb_param_inputHeight, hls::sim::Byte<4> __xlx_apatb_param_convWidth, hls::sim::Byte<4> __xlx_apatb_param_convHeight)
{
  ...
  port9.param = { __xlx_apatb_param_input_r, __xlx_apatb_param_output_r };
  port9.depth = { 1, 1 };
  port9.offset = { 0, 1 };
  ...
  port10.param = { __xlx_apatb_param_coeffs };
  port10.depth = { 1 };
  port10.offset = {  };
