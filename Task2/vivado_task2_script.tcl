...
#
# vivado_task2_script.tcl: Tcl script for re-creating project 'MidtermV2_Conv_Only_Vivado'
#
# Generated by Vivado on Thu Apr 02 12:41:23 +0200 2026
...
#
# 1. This project restoration tcl script (vivado_task2_script.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/stavs/Documents/Lab_HW_SW/Midterm_V2/Task2_Vivado/MidtermV2_Conv_Only_Vivado.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../../Task2_Vivado/MidtermV2_Conv_Only_Vivado.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../../export_task2"]"]"\
  ]
  foreach ipath $paths {
...
set script_file "vivado_task2_script.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../Task2_Vivado"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../export_task2"]" $obj
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../Task2_Vivado/MidtermV2_Conv_Only_Vivado.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]
} else {
