...
port (
    ...
    coeffs                :out  STD_LOGIC_VECTOR(31 downto 0);
...
architecture behave of Conv2D_HW_control_s_axi is
    ...
    constant ADDR_COEFFS_DATA_0      : INTEGER := 16#20#;
    constant ADDR_COEFFS_CTRL        : INTEGER := 16#24#;
    ...
    signal int_coeffs          : UNSIGNED(31 downto 0) := (others => '0');
