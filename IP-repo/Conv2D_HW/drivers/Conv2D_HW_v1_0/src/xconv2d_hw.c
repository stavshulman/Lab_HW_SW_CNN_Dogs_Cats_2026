...
void XConv2d_hw_Set_coeffs(XConv2d_hw *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XConv2d_hw_WriteReg(InstancePtr->Control_BaseAddress, XCONV2D_HW_CONTROL_ADDR_COEFFS_DATA, Data);
}

u32 XConv2d_hw_Get_coeffs(XConv2d_hw *InstancePtr) {
    u32 Data;
