...
#
# vivado_task4_script.tcl: Tcl script for re-creating project 'MidtermV2_Conv_Only_Vivado'
#
# Generated by Vivado on Thu Mar 26 22:55:40 +0100 2026
...
#
# 1. This project restoration tcl script (vivado_task4_script.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/stavs/Documents/Lab_HW_SW/Midterm_V2/Task4_Vivado/MidtermV2_Conv_Only_Vivado.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../../Task4_Vivado/MidtermV2_Conv_Only_Vivado.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../../../../AppData/Roaming/export_task4"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "MidtermV2_Conv_Only_Vivado"
...
set script_file "vivado_task4_script.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../Task4_Vivado"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../export_task4"]" $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  # Create instance: Conv2D_HW_1, and set properties
  set Conv2D_HW_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:Conv2D_HW:1.0 Conv2D_HW_1 ]
...
\
  ...
  connect_bd_intf_net -intf_net Conv2D_HW_0_m_axi_gmem0 [get_bd_intf_pins Conv2D_HW_1/m_axi_gmem0] [get_bd_intf_pins axi_interconnect_0/S00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets Conv2D_HW_0_m_axi_gmem0] [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins system_ila_1/SLOT_0_AXI]
  connect_bd_intf_net -intf_net Conv2D_HW_1_m_axi_gmem1 [get_bd_intf_pins Conv2D_HW_1/m_axi_gmem1] [get_bd_intf_pins axi_interconnect_0/S01_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins Conv2D_HW_1/s_axi_control] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Conv2D_HW_1/ap_clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins system_ila_1/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins Conv2D_HW_1/ap_rst_n] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins system_ila_1/resetn]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces Conv2D_HW_1/Data_m_axi_gmem0] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces Conv2D_HW_1/Data_m_axi_gmem1] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Conv2D_HW_1/s_axi_control/Reg] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"1.23629",
   "Default View_TopLeft":"-10,-186",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 7 -x 2130 -y 100 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 7 -x 2130 -y 130 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 6 -x 1880 -y 160 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 3 -x 880 -y 350 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 190 -y 370 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 5 -x 1530 -y 150 -defaultsOSRD
preplace inst system_ila_0 -pg 1 -lvl 4 -x 1200 -y 360 -defaultsOSRD
preplace inst system_ila_1 -pg 1 -lvl 5 -x 1530 -y 370 -defaultsOSRD
preplace inst Conv2D_HW_1 -pg 1 -lvl 2 -x 550 -y -60 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 7 10 220 360 220 730 220 1030 220 1350 0 1670 270 2090
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 7 10 480 NJ 480 N 480 NJ 480 NJ 480 NJ 480 2100
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 4 370 330 720 470 1020 440 1330
preplace netloc Conv2D_HW_0_m_axi_gmem0 1 2 3 N -80 N -80 1340
preplace netloc Conv2D_HW_1_m_axi_gmem1 1 2 3 NJ -60 NJ -60 1320
preplace netloc axi_interconnect_0_M00_AXI 1 5 1 N 150
preplace netloc processing_system7_0_DDR 1 6 1 2110J 100n
preplace netloc processing_system7_0_FIXED_IO 1 6 1 NJ 130
preplace netloc processing_system7_0_M_AXI_GP0 1 2 5 740 230 NJ 230 1320J 460 NJ 460 2110
preplace netloc ps7_0_axi_periph_M00_AXI 1 1 3 380 210 N 210 1020
preplace netloc system_ila_0_TRIG_OUT 1 4 1 N 360
levelinfo -pg 1 -10 190 550 880 1200 1530 1880 2130
pagesize -pg 1 -db -bbox -sgen -10 -140 2240 490
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../Task4_Vivado/MidtermV2_Conv_Only_Vivado.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]
} else {
...
set_property -name "incremental_checkpoint" -value "$proj_dir/MidtermV2_Conv_Only_Vivado.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/MidtermV2_Conv_Only_Vivado.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/MidtermV2_Conv_Only_Vivado.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/MidtermV2_Conv_Only_Vivado.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
